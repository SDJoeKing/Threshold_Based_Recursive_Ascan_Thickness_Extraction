...
//     uint16_t gateA_b = argFirstSmaller(arr,gateA_f, gateA_f + targetThickDataPoint,  threshold); // try to locate the falling edge within 1 time the nominal thickness range
//     if(gateA_b == 0)
//         return 0.2;
